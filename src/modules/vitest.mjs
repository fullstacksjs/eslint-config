...
function vitest(options = {}) {
  ...
  const vitestConfig = {
    ...
    rules: {
      ...
      'vitest/prefer-called-exactly-once-with': 'off', // Overlaps with prefer-called-once and prefer-called-with
      ...
      'vitest/unbound-method': 'off', // Requires type information, covered by @typescript-eslint/unbound-method
